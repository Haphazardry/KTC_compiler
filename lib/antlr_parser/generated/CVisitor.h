...
public:
   ...
   */
    ...
    virtual std::any visitIfSelection(CParser::IfSelectionContext *context) = 0;

    virtual std::any visitSwitchSelection(CParser::SwitchSelectionContext *context) = 0;

    virtual std::any visitIterationStatement(CParser::IterationStatementContext *context) = 0;

    virtual std::any visitForIterationStatement(CParser::ForIterationStatementContext *context) = 0;

    virtual std::any visitWhileIterationStatement(CParser::WhileIterationStatementContext *context) = 0;

    virtual std::any visitDoWhileIterationStatement(CParser::DoWhileIterationStatementContext *context) = 0;
    ...
    virtual std::any visitForBeforeExpression(CParser::ForBeforeExpressionContext *context) = 0;

    virtual std::any visitForAfterExpression(CParser::ForAfterExpressionContext *context) = 0;

    virtual std::any visitForMidExpression(CParser::ForMidExpressionContext *context) = 0;

    virtual std::any visitJumpStatement(CParser::JumpStatementContext *context) = 0;

    virtual std::any visitBreakpointStatement(CParser::BreakpointStatementContext *context) = 0;

    virtual std::any visitBreakpointArg(CParser::BreakpointArgContext *context) = 0;

    virtual std::any visitContinueStatement(CParser::ContinueStatementContext *context) = 0;

    virtual std::any visitBreakStatement(CParser::BreakStatementContext *context) = 0;

    virtual std::any visitReturnStatement(CParser::ReturnStatementContext *context) = 0;
