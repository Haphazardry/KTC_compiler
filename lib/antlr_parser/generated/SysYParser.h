...
public:
  ...
  enum {
    ...
    RuleLVal = 18, RulePrimaryExp = 19, RuleUnaryExp = 20, RuleFuncRParams = 21, 
    RuleMulExp = 22, RuleAddExp = 23, RuleRelExp = 24, RuleEqExp = 25, RuleLAndExp = 26, 
    RuleLOrExp = 27, RuleConstExp = 28
  };
  ...
  public:
    ...
    antlr4::tree::TerminalNode *Boolean_const();
  ...
  class  IfStatContext : public StmtContext {
  public:
    IfStatContext(StmtContext *ctx);
  ...
  class  BlockStatContext : public StmtContext {
  public:
    BlockStatContext(StmtContext *ctx);
  ...
  class  ReturnStatContext : public StmtContext {
  public:
    ReturnStatContext(StmtContext *ctx);
  ...
  class  ContinueStatContext : public StmtContext {
  public:
    ContinueStatContext(StmtContext *ctx);
  ...
  class  SemiStatContext : public StmtContext {
  public:
    SemiStatContext(StmtContext *ctx);
  ...
  class  AssignStatContext : public StmtContext {
  public:
    AssignStatContext(StmtContext *ctx);
  ...
  class  BreakStatContext : public StmtContext {
  public:
    BreakStatContext(StmtContext *ctx);
  ...
  class  WhileStatContext : public StmtContext {
  public:
    WhileStatContext(StmtContext *ctx);
  ...
  class  PrimaryExprContext : public UnaryExpContext {
  public:
    PrimaryExprContext(UnaryExpContext *ctx);
  ...
  class  SignExprContext : public UnaryExpContext {
  public:
    SignExprContext(UnaryExpContext *ctx);
  ...
  class  FunctionExprContext : public UnaryExpContext {
  public:
    FunctionExprContext(UnaryExpContext *ctx);
  ...
  public:
    SysYParser::ExpContext *expContext = nullptr;
    std::vector<ExpContext *> params;
