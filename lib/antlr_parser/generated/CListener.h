...
public:
  ...
  virtual void enterIfSelection(CParser::IfSelectionContext *ctx) = 0;
  virtual void exitIfSelection(CParser::IfSelectionContext *ctx) = 0;

  virtual void enterSwitchSelection(CParser::SwitchSelectionContext *ctx) = 0;
  virtual void exitSwitchSelection(CParser::SwitchSelectionContext *ctx) = 0;
  ...
  virtual void enterForIterationStatement(CParser::ForIterationStatementContext *ctx) = 0;
  virtual void exitForIterationStatement(CParser::ForIterationStatementContext *ctx) = 0;

  virtual void enterWhileIterationStatement(CParser::WhileIterationStatementContext *ctx) = 0;
  virtual void exitWhileIterationStatement(CParser::WhileIterationStatementContext *ctx) = 0;

  virtual void enterDoWhileIterationStatement(CParser::DoWhileIterationStatementContext *ctx) = 0;
  virtual void exitDoWhileIterationStatement(CParser::DoWhileIterationStatementContext *ctx) = 0;
  ...
  virtual void enterForBeforeExpression(CParser::ForBeforeExpressionContext *ctx) = 0;
  virtual void exitForBeforeExpression(CParser::ForBeforeExpressionContext *ctx) = 0;

  virtual void enterForAfterExpression(CParser::ForAfterExpressionContext *ctx) = 0;
  virtual void exitForAfterExpression(CParser::ForAfterExpressionContext *ctx) = 0;

  virtual void enterForMidExpression(CParser::ForMidExpressionContext *ctx) = 0;
  virtual void exitForMidExpression(CParser::ForMidExpressionContext *ctx) = 0;
  ...
  virtual void enterBreakpointStatement(CParser::BreakpointStatementContext *ctx) = 0;
  virtual void exitBreakpointStatement(CParser::BreakpointStatementContext *ctx) = 0;

  virtual void enterBreakpointArg(CParser::BreakpointArgContext *ctx) = 0;
  virtual void exitBreakpointArg(CParser::BreakpointArgContext *ctx) = 0;

  virtual void enterContinueStatement(CParser::ContinueStatementContext *ctx) = 0;
  virtual void exitContinueStatement(CParser::ContinueStatementContext *ctx) = 0;

  virtual void enterBreakStatement(CParser::BreakStatementContext *ctx) = 0;
  virtual void exitBreakStatement(CParser::BreakStatementContext *ctx) = 0;

  virtual void enterReturnStatement(CParser::ReturnStatementContext *ctx) = 0;
  virtual void exitReturnStatement(CParser::ReturnStatementContext *ctx) = 0;
