...
public:
  ...
  virtual std::any visitIfSelection(CParser::IfSelectionContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitSwitchSelection(CParser::SwitchSelectionContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitForIterationStatement(CParser::ForIterationStatementContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitWhileIterationStatement(CParser::WhileIterationStatementContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitDoWhileIterationStatement(CParser::DoWhileIterationStatementContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitForBeforeExpression(CParser::ForBeforeExpressionContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitForAfterExpression(CParser::ForAfterExpressionContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitForMidExpression(CParser::ForMidExpressionContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitBreakpointStatement(CParser::BreakpointStatementContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitBreakpointArg(CParser::BreakpointArgContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitContinueStatement(CParser::ContinueStatementContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitBreakStatement(CParser::BreakStatementContext *ctx) override {
    return visitChildren(ctx);
  }
