...
public:
  ...
  enum {
    ...
    RuleDirectDeclarator = 48, RuleVcSpecificModifer = 49, RuleNestedParenthesesBlock = 50, 
    RulePointer = 51, RuleTypeQualifierList = 52, RuleParameterTypeList = 53, 
    RuleParameterList = 54, RuleParameterDeclaration = 55, RuleIdentifierList = 56, 
    RuleTypeName = 57, RuleAbstractDeclarator = 58, RuleDirectAbstractDeclarator = 59, 
    RuleTypedefName = 60, RuleInitializer = 61, RuleInitializerList = 62, 
    RuleDesignation = 63, RuleDesignatorList = 64, RuleDesignator = 65, 
    RuleStaticAssertDeclaration = 66, RuleStatement = 67, RuleLabeledStatement = 68, 
    RuleCompoundStatement = 69, RuleBlockItemList = 70, RuleBlockItem = 71, 
    RuleExpressionStatement = 72, RuleSelectionStatement = 73, RuleIfSelection = 74, 
    RuleSwitchSelection = 75, RuleIterationStatement = 76, RuleForIterationStatement = 77, 
    RuleWhileIterationStatement = 78, RuleDoWhileIterationStatement = 79, 
    RuleForCondition = 80, RuleForDeclaration = 81, RuleForBeforeExpression = 82, 
    RuleForAfterExpression = 83, RuleForMidExpression = 84, RuleJumpStatement = 85, 
    RuleBreakpointStatement = 86, RuleBreakpointArg = 87, RuleContinueStatement = 88, 
    RuleBreakStatement = 89, RuleReturnStatement = 90, RuleCompilationUnit = 91, 
    RuleTranslationUnit = 92, RuleExternalDeclaration = 93, RuleFunctionDefinition = 94, 
    RuleDeclarationList = 95
  };
  ...
  class IfSelectionContext;
  class SwitchSelectionContext;
  class IterationStatementContext;
  class ForIterationStatementContext;
  class WhileIterationStatementContext;
  class DoWhileIterationStatementContext;
  class ForConditionContext;
  class ForDeclarationContext;
  class ForBeforeExpressionContext;
  class ForAfterExpressionContext;
  class ForMidExpressionContext;
  class JumpStatementContext;
  class BreakpointStatementContext;
  class BreakpointArgContext;
  ...
  public:
    ...
    BreakpointStatementContext *breakpointStatement();
    antlr4::tree::TerminalNode *LeftParen();
    antlr4::tree::TerminalNode *RightParen();
    antlr4::tree::TerminalNode *Semi();
    antlr4::tree::TerminalNode *Volatile();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    IfSelectionContext *ifSelection();
    SwitchSelectionContext *switchSelection();
  ...
  class  IfSelectionContext : public antlr4::ParserRuleContext {
  public:
    IfSelectionContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class  SwitchSelectionContext : public antlr4::ParserRuleContext {
  public:
    SwitchSelectionContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    WhileIterationStatementContext *whileIterationStatement();
    DoWhileIterationStatementContext *doWhileIterationStatement();
    ForIterationStatementContext *forIterationStatement();
  ...
  class  ForIterationStatementContext : public antlr4::ParserRuleContext {
  public:
    ForIterationStatementContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class  WhileIterationStatementContext : public antlr4::ParserRuleContext {
  public:
    WhileIterationStatementContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  class  DoWhileIterationStatementContext : public antlr4::ParserRuleContext {
  public:
    DoWhileIterationStatementContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    ForBeforeExpressionContext *forBeforeExpression();
    std::vector<antlr4::tree::TerminalNode *> Semi();
    antlr4::tree::TerminalNode* Semi(size_t i);
    ForMidExpressionContext *forMidExpression();
    ForAfterExpressionContext *forAfterExpression();
  ...
  class  ForBeforeExpressionContext : public antlr4::ParserRuleContext {
  public:
    ForBeforeExpressionContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    ForDeclarationContext *forDeclaration();
    ExpressionContext *expression();
  ...
  class  ForAfterExpressionContext : public antlr4::ParserRuleContext {
  public:
    ForAfterExpressionContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    ExpressionContext *expression();
  ...
  class  ForMidExpressionContext : public antlr4::ParserRuleContext {
  public:
    ForMidExpressionContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    ExpressionContext *expression();
  ...
  class  BreakpointStatementContext : public antlr4::ParserRuleContext {
  public:
    BreakpointStatementContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    ...
    antlr4::tree::TerminalNode *LeftParen();
    antlr4::tree::TerminalNode *RightParen();
    std::vector<BreakpointArgContext *> breakpointArg();
    BreakpointArgContext* breakpointArg(size_t i);
    std::vector<antlr4::tree::TerminalNode *> Comma();
    antlr4::tree::TerminalNode* Comma(size_t i);
  ...
  class  BreakpointArgContext : public antlr4::ParserRuleContext {
  public:
    BreakpointArgContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    std::vector<antlr4::tree::TerminalNode *> Identifier();
    antlr4::tree::TerminalNode* Identifier(size_t i);
    antlr4::tree::TerminalNode *Dot();
  ...
  BreakpointArgContext* breakpointArg();
